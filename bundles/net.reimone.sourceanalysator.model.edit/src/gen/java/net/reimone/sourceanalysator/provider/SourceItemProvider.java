...
public class SourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Source_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Source_url_feature", "_UI_Source_type"),
				 SourceanalysatorPackage.Literals.SOURCE__URL,
				 true,
				 false,
				 false,
	...
	protected void addArticlesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Source_articles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Source_articles_feature", "_UI_Source_type"),
				 SourceanalysatorPackage.Literals.SOURCE__ARTICLES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Source)object).getUrl();
