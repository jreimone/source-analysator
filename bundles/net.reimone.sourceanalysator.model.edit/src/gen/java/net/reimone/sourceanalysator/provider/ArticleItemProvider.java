...
/**
 * This is the item provider adapter for a {@link net.reimone.sourceanalysator.Article} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArticleItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Article_sources_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Article_sources_feature", "_UI_Article_type"),
				 SourceanalysatorPackage.Literals.ARTICLE__SOURCES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Article_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Article_title_feature", "_UI_Article_type"),
				 SourceanalysatorPackage.Literals.ARTICLE__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addLocalFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Article_localFile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Article_localFile_feature", "_UI_Article_type"),
				 SourceanalysatorPackage.Literals.ARTICLE__LOCAL_FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Article)object).getTitle();
